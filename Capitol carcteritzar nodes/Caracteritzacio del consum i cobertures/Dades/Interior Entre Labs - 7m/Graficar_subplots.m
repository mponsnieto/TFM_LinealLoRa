...
ylabel('Tensió a P12 (V)')
%% Lectura HTU
t_sendGTW=t(find(time>0.3-offset_t & time<0.74+offset_t));
y1_sendGTW=y1(find(time>0.3-offset_t & time<0.74+offset_t));
y2_sendGTW=y2(find(time>0.3-offset_t & time<0.74+offset_t));
figure();
subplot(2,1,1);
plot(t_sendGTW,y1_sendGTW);
...
%% Lectura camera
t_sendGTW=t(find(time>-2.56-offset_t & time<0.05+offset_t));
y1_sendGTW=y1(find(time>-2.56-offset_t & time<0.05+offset_t));
y2_sendGTW=y2(find(time>-2.56-offset_t & time<0.05+offset_t));
figure();
subplot(2,1,1);
plot(t_sendGTW,y1_sendGTW);
...
ylabel('Tensió a P12 (V)')
%% Lectura QAire
t_sendGTW=t(find(time>-3.45-offset_t & time<-2.86+offset_t));
y1_sendGTW=y1(find(time>-3.45-offset_t & time<-2.86+offset_t));
y2_sendGTW=y2(find(time>-3.45-offset_t & time<-2.86+offset_t));
figure();
subplot(2,1,1);
plot(t_sendGTW,y1_sendGTW);
...
%% Lectura MCP
t_mcp=t(find(time>-4.13-offset_t & time<-3.45+offset_t));
y1_mcp=y1(find(time>-4.13-offset_t & time<-3.45+offset_t));
y2_mcp=y2(find(time>-4.13-offset_t & time<-3.45+offset_t));
figure();
subplot(2,1,1);
plot(t_mcp,y1_mcp);
...
%% Lectura bmp
t_bmp=t(find(time>-5.6-offset_t & time<-4.43+offset_t));
y1_bmp=y1(find(time>-5.6-offset_t & time<-4.43+offset_t));
y2_bmp=y2(find(time>-5.6-offset_t & time<-4.43+offset_t));
figure();
subplot(2,1,1);
plot(t_bmp,y1_bmp);
...
ylabel('Tensió a P12 (V)')
%% Lectura start
t_start=t(find(time>-7-offset_t & time<-6.127+offset_t));
y1_start=y1(find(time>-7-offset_t & time<-6.127+offset_t));
y2_start=y2(find(time>-7-offset_t & time<-6.127+offset_t));
figure();
subplot(2,1,1);
