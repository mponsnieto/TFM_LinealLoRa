...
xlabel('Temps (s)')
title('Consums durant la prova del laboratori den Tomeu')
...
t_sendGTW=t(find(time>14.2-offset_t & time<19.45+offset_t));
y1_sendGTW=y1(find(time>14.2-offset_t & time<19.45+offset_t));
y2_sendGTW=y2(find(time>14.2-offset_t & time<19.45+offset_t));
figure();
subplot(2,1,1);
