...
class NanoGateway:
    ...
    def _push_data(self, data):
        ...
        with self.udp_lock:
            try:
                ...
                self.saveFile("Error to push uplink to server")
    ...
    def saveFile(self,msg):
        ...
        f = open('data_msgs.txt', 'a')
        f.write("{}/{}/{} {}:{}:{} {}\n".format(self.rtc.now()[2],self.rtc.now()[1],self.rtc.now()[0],self.rtc.now()[3],self.rtc.now()[4],self.rtc.now()[5],msg))
        f.close()
        return
